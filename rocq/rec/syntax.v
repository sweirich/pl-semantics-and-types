...
Ltac asimpl' := repeat (first
                 ...
                 | progress
                    unfold up_list_Ty_Ty, up_Ty_Ty, upRen_list_Ty_Ty,
                     upRen_Ty_Ty, up_list_Val_Val, up_Val_Val,
                     upRen_list_Val_Val, upRen_Val_Val, up_ren
                 | progress
                    cbn[subst_Ty ren_Ty subst_Tm subst_Val ren_Tm ren_Val]
                 | progress fsimpl ]).
...
Ltac asimpl := check_no_evars;
                repeat
                 unfold VarInstance_Val, Var, ids, Ren_Val, Ren1, ren1,
                  ...
                  Subst1, subst1, Subst_Tm, Subst1, subst1, VarInstance_Ty,
                  Var, ids, Ren_Ty, Ren1, ren1, Up_Ty_Ty, Up_Ty, up_Ty,
                  Subst_Ty, Subst1, subst1 in *;
                asimpl'; minimize.
