...
Lemma congr_Cont {m_Ty : nat} {s0 : Ty m_Ty} {t0 : Ty m_Ty} (H0 : s0 = t0) :
  Cont m_Ty s0 = Cont m_Ty t0.
Proof.
exact (eq_trans eq_refl (ap (fun x => Cont m_Ty x) H0)).
Qed.

Lemma congr_Eff {m_Ty : nat} {s0 : Ty m_Ty} {t0 : Ty m_Ty} (H0 : s0 = t0) :
  Eff m_Ty s0 = Eff m_Ty t0.
Proof.
exact (eq_trans eq_refl (ap (fun x => Eff m_Ty x) H0)).
Qed.

Lemma congr_DeCont {m_Ty : nat} {s0 : Ty m_Ty} {s1 : Ty m_Ty} {t0 : Ty m_Ty}
  {t1 : Ty m_Ty} (H0 : s0 = t0) (H1 : s1 = t1) :
  DeCont m_Ty s0 s1 = DeCont m_Ty t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => DeCont m_Ty x s1) H0))
         (ap (fun x => DeCont m_Ty t0 x) H1)).
Qed.

Lemma congr_List {m_Ty : nat} {s0 : Ty m_Ty} {t0 : Ty m_Ty} (H0 : s0 = t0) :
  List m_Ty s0 = List m_Ty t0.
Proof.
exact (eq_trans eq_refl (ap (fun x => List m_Ty x) H0)).
Qed.
...
(s : Ty m_Ty) {struct s} : Ty n_Ty :=
  ...
  | List _ s0 => List n_Ty (ren_Ty xi_Ty s0)
  end.
...
(s : Ty m_Ty) {struct s} : Ty n_Ty :=
  ...
  | DeCont _ s0 s1 =>
      DeCont n_Ty (subst_Ty sigma_Ty s0) (subst_Ty sigma_Ty s1)
  | List _ s0 => List n_Ty (subst_Ty sigma_Ty s0)
  end.
...
subst_Ty sigma_Ty s = s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (idSubst_Ty sigma_Ty Eq_Ty s0)
        (idSubst_Ty sigma_Ty Eq_Ty s1)
  | List _ s0 => congr_List (idSubst_Ty sigma_Ty Eq_Ty s0)
  end.
...
(s : Ty m_Ty) {struct s} : ren_Ty xi_Ty s = ren_Ty zeta_Ty s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (extRen_Ty xi_Ty zeta_Ty Eq_Ty s0)
        (extRen_Ty xi_Ty zeta_Ty Eq_Ty s1)
  | List _ s0 => congr_List (extRen_Ty xi_Ty zeta_Ty Eq_Ty s0)
  end.
...
(s : Ty m_Ty) {struct s} : subst_Ty sigma_Ty s = subst_Ty tau_Ty s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (ext_Ty sigma_Ty tau_Ty Eq_Ty s0)
        (ext_Ty sigma_Ty tau_Ty Eq_Ty s1)
  | List _ s0 => congr_List (ext_Ty sigma_Ty tau_Ty Eq_Ty s0)
  end.
...
ren_Ty zeta_Ty (ren_Ty xi_Ty s) = ren_Ty rho_Ty s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s0)
        (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s1)
  | List _ s0 => congr_List (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s0)
  end.
...
subst_Ty tau_Ty (ren_Ty xi_Ty s) = subst_Ty theta_Ty s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s0)
        (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s1)
  | List _ s0 => congr_List (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s0)
  end.
...
ren_Ty zeta_Ty (subst_Ty sigma_Ty s) = subst_Ty theta_Ty s :=
  ...
  | Eff _ s0 =>
      congr_Eff (compSubstRen_Ty sigma_Ty zeta_Ty theta_Ty Eq_Ty s0)
  | DeCont _ s0 s1 =>
      congr_DeCont (compSubstRen_Ty sigma_Ty zeta_Ty theta_Ty Eq_Ty s0)
        (compSubstRen_Ty sigma_Ty zeta_Ty theta_Ty Eq_Ty s1)
  | List _ s0 =>
      congr_List (compSubstRen_Ty sigma_Ty zeta_Ty theta_Ty Eq_Ty s0)
  end.
...
subst_Ty tau_Ty (subst_Ty sigma_Ty s) = subst_Ty theta_Ty s :=
  ...
  | Eff _ s0 =>
      congr_Eff (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s0)
  | DeCont _ s0 s1 =>
      congr_DeCont (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s0)
        (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s1)
  | List _ s0 =>
      congr_List (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s0)
  end.
...
{struct s} : ren_Ty xi_Ty s = subst_Ty sigma_Ty s :=
  ...
  | DeCont _ s0 s1 =>
      congr_DeCont (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s0)
        (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s1)
  | List _ s0 => congr_List (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s0)
  end.
