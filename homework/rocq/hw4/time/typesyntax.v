...
Inductive Ty (n_Ty : nat) : Type :=
  ...
  | Void : Ty n_Ty
  | Nat : Ty n_Ty
  | Prod : Eff -> Ty n_Ty -> Ty n_Ty -> Ty n_Ty
  | Sum : Ty n_Ty -> Ty n_Ty -> Ty n_Ty
  | Arr : Ty n_Ty -> Eff -> Ty n_Ty -> Ty n_Ty
...
Lemma congr_Prod {m_Ty : nat} {s0 : Eff} {s1 : Ty m_Ty} {s2 : Ty m_Ty}
  {t0 : Eff} {t1 : Ty m_Ty} {t2 : Ty m_Ty} (H0 : s0 = t0) (H1 : s1 = t1)
  (H2 : s2 = t2) : Prod m_Ty s0 s1 s2 = Prod m_Ty t0 t1 t2.
Proof.
exact (eq_trans
         (eq_trans (eq_trans eq_refl (ap (fun x => Prod m_Ty x s1 s2) H0))
            (ap (fun x => Prod m_Ty t0 x s2) H1))
         (ap (fun x => Prod m_Ty t0 t1 x) H2)).
Qed.
...
Lemma congr_Arr {m_Ty : nat} {s0 : Ty m_Ty} {s1 : Eff} {s2 : Ty m_Ty}
  {t0 : Ty m_Ty} {t1 : Eff} {t2 : Ty m_Ty} (H0 : s0 = t0) (H1 : s1 = t1)
  (H2 : s2 = t2) : Arr m_Ty s0 s1 s2 = Arr m_Ty t0 t1 t2.
Proof.
exact (eq_trans
         (eq_trans (eq_trans eq_refl (ap (fun x => Arr m_Ty x s1 s2) H0))
            (ap (fun x => Arr m_Ty t0 x s2) H1))
         (ap (fun x => Arr m_Ty t0 t1 x) H2)).
Qed.
...
(s : Ty m_Ty) {struct s} : Ty n_Ty :=
  ...
  | Void _ => Void n_Ty
  | Nat _ => Nat n_Ty
  | Prod _ s0 s1 s2 => Prod n_Ty s0 (ren_Ty xi_Ty s1) (ren_Ty xi_Ty s2)
  | Sum _ s0 s1 => Sum n_Ty (ren_Ty xi_Ty s0) (ren_Ty xi_Ty s1)
  | Arr _ s0 s1 s2 => Arr n_Ty (ren_Ty xi_Ty s0) s1 (ren_Ty xi_Ty s2)
...
(s : Ty m_Ty) {struct s} : Ty n_Ty :=
  ...
  | Nat _ => Nat n_Ty
  | Prod _ s0 s1 s2 =>
      Prod n_Ty s0 (subst_Ty sigma_Ty s1) (subst_Ty sigma_Ty s2)
  | Sum _ s0 s1 => Sum n_Ty (subst_Ty sigma_Ty s0) (subst_Ty sigma_Ty s1)
  | Arr _ s0 s1 s2 =>
      Arr n_Ty (subst_Ty sigma_Ty s0) s1 (subst_Ty sigma_Ty s2)
...
subst_Ty sigma_Ty s = s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0) (idSubst_Ty sigma_Ty Eq_Ty s1)
        (idSubst_Ty sigma_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (idSubst_Ty sigma_Ty Eq_Ty s0) (idSubst_Ty sigma_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (idSubst_Ty sigma_Ty Eq_Ty s0) (eq_refl s1)
        (idSubst_Ty sigma_Ty Eq_Ty s2)
  | Mu _ s0 =>
...
(s : Ty m_Ty) {struct s} : ren_Ty xi_Ty s = ren_Ty zeta_Ty s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0) (extRen_Ty xi_Ty zeta_Ty Eq_Ty s1)
        (extRen_Ty xi_Ty zeta_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (extRen_Ty xi_Ty zeta_Ty Eq_Ty s0)
        (extRen_Ty xi_Ty zeta_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (extRen_Ty xi_Ty zeta_Ty Eq_Ty s0) (eq_refl s1)
        (extRen_Ty xi_Ty zeta_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
...
(s : Ty m_Ty) {struct s} : subst_Ty sigma_Ty s = subst_Ty tau_Ty s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0) (ext_Ty sigma_Ty tau_Ty Eq_Ty s1)
        (ext_Ty sigma_Ty tau_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (ext_Ty sigma_Ty tau_Ty Eq_Ty s0)
        (ext_Ty sigma_Ty tau_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (ext_Ty sigma_Ty tau_Ty Eq_Ty s0) (eq_refl s1)
        (ext_Ty sigma_Ty tau_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
...
ren_Ty zeta_Ty (ren_Ty xi_Ty s) = ren_Ty rho_Ty s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0) (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s1)
        (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s0)
        (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s0) (eq_refl s1)
        (compRenRen_Ty xi_Ty zeta_Ty rho_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
...
subst_Ty tau_Ty (ren_Ty xi_Ty s) = subst_Ty theta_Ty s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0)
        (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s1)
        (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s0)
        (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s0) (eq_refl s1)
        (compRenSubst_Ty xi_Ty tau_Ty theta_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
...
subst_Ty tau_Ty (subst_Ty sigma_Ty s) = subst_Ty theta_Ty s :=
  ...
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0)
        ...
        (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
  ...
  | Arr _ s0 s1 s2 =>
      congr_Arr (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s0)
        (eq_refl s1) (compSubstSubst_Ty sigma_Ty tau_Ty theta_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
...
{struct s} : ren_Ty xi_Ty s = subst_Ty sigma_Ty s :=
  ...
  | Nat _ => congr_Nat
  | Prod _ s0 s1 s2 =>
      congr_Prod (eq_refl s0) (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s1)
        (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s2)
  | Sum _ s0 s1 =>
      congr_Sum (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s0)
        (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s1)
  | Arr _ s0 s1 s2 =>
      congr_Arr (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s0) (eq_refl s1)
        (rinst_inst_Ty xi_Ty sigma_Ty Eq_Ty s2)
  | Mu _ s0 =>
      congr_Mu
