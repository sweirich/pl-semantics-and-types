...
(* Autosubst also can only use this notation for one specific sort of 
  substitution. We disable it for types as it is more important to 
  have it available for terms/values. Also important to import the 
  typesyntax before the term syntax. *)
